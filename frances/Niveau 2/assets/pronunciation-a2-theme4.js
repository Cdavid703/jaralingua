  ...
  const STAGES = [
    {
      ...
      tips: ["Montez légèrement la voix à la fin : c'est une question.", "Lisez le groupe « pour deux personnes » sans couper chaque mot."]
    },
    {
      ...
      tips: ["Gardez « je voudrais » doux et poli.", "Faites la liaison naturelle dans « plat du jour » en gardant le rythme."]
    },
    {
      ...
      tips: ["Dans « j'ai faim », ne prononcez pas le m final comme en espagnol.", "La négation forme un bloc : ne mange pas de viande."]
    },
    {
      ...
      tips: ["Respectez les pauses entre la question, la commande et le commentaire.", "Prononcez clairement les partitifs : de la, du, de l'."]
    }
  ];

  const API_PATH = "/api/french8/pronunciation-assessment";
  const STORAGE_KEY = "jaralingua:french2:pronunciation:restaurant:v1";
