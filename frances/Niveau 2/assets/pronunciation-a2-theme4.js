(() => {
  ...
  const STAGES = [
    {
      title: "Mini-d\u00e9fi 1 \u00b7 Demander une table",
      audio: "../audio/prononciation/theme-4/stage-1.mp3?v=20260630-n2-pron-pro",
      text: "Bonjour, vous avez une table pour deux personnes ?",
      tips: [
        "Montez l\u00e9g\u00e8rement la voix \u00e0 la fin : c'est une question.",
        "Lisez le groupe pour deux personnes sans couper chaque mot."
      ]
    },
    {
      title: "Mini-d\u00e9fi 2 \u00b7 Commander poliment",
      audio: "../audio/prononciation/theme-4/stage-2.mp3?v=20260630-n2-pron-pro",
      text: "Je voudrais de l'eau et le plat du jour, s'il vous pla\u00eet.",
      tips: [
        "Gardez je voudrais doux et poli.",
        "Faites une pause courte avant s'il vous pla\u00eet."
      ]
    },
    {
      title: "Mini-d\u00e9fi 3 \u00b7 Expression du th\u00e8me",
      audio: "../audio/prononciation/theme-4/stage-3.mp3?v=20260630-n2-pron-pro",
      text: "J'ai faim, mais je ne mange pas de viande.",
      tips: [
        "Dans j'ai faim, ne prononcez pas le m final comme en espagnol.",
        "La n\u00e9gation forme un bloc : ne mange pas de viande."
      ]
    },
    {
      title: "D\u00e9fi final \u00b7 Au restaurant",
      audio: "../audio/prononciation/theme-4/defi-final.mp3?v=20260630-n2-pron-pro",
      text: "Qu'est-ce que vous recommandez ? Je prends de la salade, du pain et de l'eau. C'est copieux.",
      tips: [
        "Respectez les pauses entre la question, la commande et le commentaire.",
        "Prononcez clairement les partitifs : de la, du, de l'."
      ]
    }
  ];

  const API_PATH = "/api/french8/pronunciation-assessment";
  const STORAGE_KEY = "jaralingua:french2:pronunciation:restaurant:v2";
  const LEGACY_STORAGE_KEY = "jaralingua:french2:pronunciation:restaurant:v1";
