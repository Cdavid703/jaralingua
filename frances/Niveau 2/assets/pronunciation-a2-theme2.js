(() => {
  ...
  const STAGES = [
    {
      title: "Mini-d\u00e9fi 1 \u00b7 Les v\u00eatements",
      text: "Je porte une chemise blanche et un pantalon noir.",
      audio: "../audio/prononciation/theme-2/stage-1.mp3?v=20260626-n2-t2",
      tips: [
        "Prononcez clairement chemise : le son ch reste doux, comme dans chocolat.",
        "Marquez une petite pause entre chemise blanche et pantalon noir."
      ]
    },
    {
      title: "Mini-d\u00e9fi 2 \u00b7 La taille",
      text: "Vous avez cette veste en taille M, s\u2019il vous pla\u00eet ?",
      audio: "../audio/prononciation/theme-2/stage-2.mp3?v=20260626-n2-t2",
      tips: [
        "Gardez l\u2019intonation montante pour la question.",
        "Lisez s\u2019il vous pla\u00eet comme un seul groupe poli."
      ]
    },
    {
      title: "Mini-d\u00e9fi 3 \u00b7 Le prix",
      text: "Combien co\u00fbte cette robe rouge ?",
      audio: "../audio/prononciation/theme-2/stage-3.mp3?v=20260626-n2-t2",
      tips: [
        "Dans combien, gardez le son nasal court et clair.",
        "Le t de co\u00fbte se prononce; le e final de rouge reste tr\u00e8s l\u00e9ger."
      ]
    },
    {
      title: "D\u00e9fi final \u00b7 Dans la boutique",
      text: "Bonjour, je voudrais essayer cette veste bleue. Vous avez la taille M ? Combien \u00e7a co\u00fbte ?",
      audio: "../audio/prononciation/theme-2/defi-final.mp3?v=20260626-n2-t2",
      tips: [
        "Lisez comme un dialogue naturel, pas comme une liste.",
        "Respectez les trois intentions : demander, pr\u00e9ciser la taille, demander le prix."
      ]
    }
  ];

  const API_PATH = "/api/french8/pronunciation-assessment";
  const STORAGE_KEY = "jaralingua:french2:pronunciation:vetements:v2";
  const LEGACY_STORAGE_KEY = "jaralingua:french2:pronunciation:vetements:v1";
