  ...
  const STAGES = [
    {
      ...
      tips: ["Prononcez clairement chemise : le son ch est doux, comme dans chocolat.", "Marquez une petite pause entre chemise blanche et pantalon noir."]
    },
    {
      ...
      tips: ["Gardez l’intonation montante pour la question.", "Ne prononcez pas fortement le s final de vous."]
    },
    {
      ...
      tips: ["Dans combien, le son nasal doit rester fermé et court.", "Le t de coûte se prononce; le e final de rouge est très léger."]
    },
    {
      ...
      tips: ["Lisez comme un dialogue naturel, pas comme une liste.", "Respectez les trois intentions : demander, préciser la taille, demander le prix."]
    }
  ];

  const API_PATH = "/api/french8/pronunciation-assessment";
  const STORAGE_KEY = "jaralingua:french2:pronunciation:vetements:v1";
