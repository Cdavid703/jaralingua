  ...
  const STAGES = [
    {
      ...
      tips: [
        "Gardez le groupe il fait beau comme une unit\u00e9.",
        "Dans soleil, ouvrez bien la voyelle finale : so-leil."
      ]
    },
    {
      ...
      tips: [
        "Liaison possible dans nous allons.",
        "L'expression profiter du beau temps doit \u00eatre dite avec un rythme naturel."
      ]
    },
    {
      ...
      tips: [
        "Ne prononcez pas le s final de plus devant chaud.",
        "Marquez une petite pause apr\u00e8s samedi."
      ]
    },
    {
      ...
      tips: [
        "La question finale monte l\u00e9g\u00e8rement.",
        "Rester au chaud est une expression idiomatique utile quand il fait froid ou mauvais."
      ]
    }
  ];

  const API_PATH = "/api/french8/pronunciation-assessment";
  const STORAGE_KEY = "jaralingua:french2:pronunciation:theme6:v2";
  const LEGACY_STORAGE_KEY = "jaralingua:french2:pronunciation:theme6:v1";
