  ...
  const STAGES = [
    {
      ...
      tips: ["Gardez deux groupes : j'ai mal à la tête / et j'ai mal au ventre.", "À + le ventre devient au ventre."]
    },
    {
      ...
      tips: ["Cette expression signifie que la personne ne se sent pas bien.", "Lisez toute l'expression comme une seule idée, sans traduire mot par mot."]
    },
    {
      ...
      tips: ["Après il faut, le verbe reste à l'infinitif.", "Ne prononcez pas une voyelle finale après faut."]
    },
    {
      ...
      tips: ["Faites une pause après Bonjour.", "La question finale doit monter légèrement : Qu'est-ce qu'il faut prendre ?"]
    }
  ];

  const API_PATH = "/api/french8/pronunciation-assessment";
  const STORAGE_KEY = "jaralingua:french2:pronunciation:sante:v1";
