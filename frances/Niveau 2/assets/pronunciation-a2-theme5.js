(() => {
  ...
  const STAGES = [
    {
      title: "Mini-d\u00e9fi 1 \u00b7 Dire o\u00f9 on a mal",
      audio: "../audio/prononciation/theme-5/stage-1.mp3?v=20260630-n2-pron-pro",
      text: "J'ai mal \u00e0 la t\u00eate et j'ai mal au ventre.",
      tips: [
        "Gardez deux groupes : j'ai mal \u00e0 la t\u00eate / et j'ai mal au ventre.",
        "\u00c0 + le ventre devient au ventre."
      ]
    },
    {
      title: "Mini-d\u00e9fi 2 \u00b7 Expliquer l'\u00e9tat g\u00e9n\u00e9ral",
      audio: "../audio/prononciation/theme-5/stage-2.mp3?v=20260630-n2-pron-pro",
      text: "Aujourd'hui, je ne suis pas dans mon assiette.",
      tips: [
        "Cette expression signifie que la personne ne se sent pas bien.",
        "Lisez toute l'expression comme une seule id\u00e9e, sans traduire mot par mot."
      ]
    },
    {
      title: "Mini-d\u00e9fi 3 \u00b7 Donner une recommandation",
      audio: "../audio/prononciation/theme-5/stage-3.mp3?v=20260630-n2-pron-pro",
      text: "Il faut boire de l'eau et se reposer.",
      tips: [
        "Apr\u00e8s il faut, le verbe reste \u00e0 l'infinitif.",
        "Ne prononcez pas une voyelle finale apr\u00e8s faut."
      ]
    },
    {
      title: "D\u00e9fi final \u00b7 \u00c0 la pharmacie",
      audio: "../audio/prononciation/theme-5/defi-final.mp3?v=20260630-n2-pron-pro",
      text: "Bonjour, je ne suis pas dans mon assiette. J'ai mal \u00e0 la gorge. Qu'est-ce qu'il faut prendre ?",
      tips: [
        "Faites une pause apr\u00e8s Bonjour.",
        "La question finale doit monter l\u00e9g\u00e8rement : Qu'est-ce qu'il faut prendre ?"
      ]
    }
  ];

  const API_PATH = "/api/french8/pronunciation-assessment";
  const STORAGE_KEY = "jaralingua:french2:pronunciation:sante:v2";
  const LEGACY_STORAGE_KEY = "jaralingua:french2:pronunciation:sante:v1";
