(() => {
  ...
  const STAGES = [
    {
      title: "Mini-défi 1 · Les pièces",
      audio: "../audio/prononciation/theme-3/stage-1.mp3?v=20260630-n2-pron-pro",
      text: "Dans mon appartement, il y a un salon, une cuisine et deux chambres.",
      tips: ["Prononcez appartement en quatre temps simples : a-par-te-ment.", "Dans il y a, ne séparez pas les trois mots : gardez un seul petit groupe."]
    },
    {
      title: "Mini-défi 2 · Les meubles",
      audio: "../audio/prononciation/theme-3/stage-2.mp3?v=20260630-n2-pron-pro",
      text: "Dans le salon, le canapé est devant la table basse.",
      tips: ["Marquez une petite pause après Dans le salon.", "Dans devant, le son nasal doit rester clair; ne prononcez pas le t final."]
    },
    {
      title: "Mini-défi 3 · La négation",
      audio: "../audio/prononciation/theme-3/stage-3.mp3?v=20260630-n2-pron-pro",
      text: "Il n'y a pas de balcon, mais il y a une grande fenêtre.",
      tips: ["La négation forme un bloc : il n'y a pas de.", "Dans grande fenêtre, gardez le rythme sans ajouter de voyelle après grande."]
    },
    {
      title: "Défi final · Chez moi",
      audio: "../audio/prononciation/theme-3/defi-final.mp3?v=20260630-n2-pron-pro",
      text: "J'habite dans un petit logement près de l'université. Il est lumineux et je me sens chez moi.",
      tips: ["Cette phrase prépare une présentation orale : lisez avec calme et intention.", "L'expression je me sens chez moi signifie que le logement est personnel, confortable et familier."]
    }
  ];

  const API_PATH = "/api/french8/pronunciation-assessment";
  const STORAGE_KEY = "jaralingua:french2:pronunciation:logement:v1";
  ...
  function applyScore(result, paint = true) {
    ...
    els.feedback.textContent = result.feedback || (score >= 85 ? "Très bien. Votre description est claire." : "Reprenez les mots soulignés et écoutez le modèle encore une fois.");
