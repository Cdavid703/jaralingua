(() => {
  ...
  const STAGES = [
    {
      ...
      tips: [
        "Prononcez appartement en quatre temps simples : a-par-te-ment.",
        "Dans il y a, gardez un seul petit groupe."
      ]
    },
    {
      ...
      tips: [
        "Marquez une petite pause apr\u00e8s Dans le salon.",
        "Dans devant, le son nasal doit rester clair; ne prononcez pas le t final."
      ]
    },
    {
      ...
      tips: [
        "La n\u00e9gation forme un bloc : il n'y a pas de.",
        "Dans grande fen\u00eatre, gardez le rythme sans ajouter de voyelle apr\u00e8s grande."
      ]
    },
    {
      ...
      tips: [
        "Cette phrase pr\u00e9pare une pr\u00e9sentation orale : lisez avec calme et intention.",
        "L'expression je me sens chez moi signifie que le logement est personnel, confortable et familier."
      ]
    }
  ];

  const API_PATH = "/api/french8/pronunciation-assessment";
  const STORAGE_KEY = "jaralingua:french2:pronunciation:logement:v2";
  const LEGACY_STORAGE_KEY = "jaralingua:french2:pronunciation:logement:v1";
  ...
  function feedbackFor(result) {
    ...
    const base = score >= 88
      ? "Tr\u00e8s bien. Votre description est claire et le rythme reste naturel."
      : score >= 70
