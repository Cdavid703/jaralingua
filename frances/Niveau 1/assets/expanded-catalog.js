...
"ecoute-portrait":A("Qui est Sofia ?","Thème 6 · Description, professions et présent progressif","Compréhension orale","Écoutez un portrait physique et moral complet.",from([
...
C["professions-activites"]=A("Professions et activités","Thème 6 · Description, professions et présent progressif","Vocabulaire en contexte","Associez les métiers aux activités et choisissez les phrases naturelles pour présenter une personne.",from([
["Quelle phrase donne correctement une profession ?",["Elle est médecin.","Elle a médecin.","Elle fait médecin."],0,"Avec une profession, on utilise généralement être : elle est médecin."],
["Que fait une infirmière ?",["Elle soigne les patients.","Elle vend des chaussures.","Elle conduit un bus."],0,"Soigner les patients correspond au domaine de la santé."],
["Quel métier travaille souvent dans une école ?",["Un professeur","Un cuisinier","Un vendeur"],0,"Un professeur travaille souvent dans une école, un collège ou une université."],
["Complétez : Il est ___ dans un restaurant.",["cuisinier","infirmier","étudiant"],0,"Un cuisinier prépare des repas dans un restaurant."],
["Quelle activité correspond à un vendeur ?",["Il aide les clients.","Il coupe les cheveux.","Il soigne les animaux."],0,"Un vendeur accueille et aide les clients."],
["Quelle phrase est correcte pour une étudiante ?",["Elle étudie à l’université.","Elle étude à l’université.","Elle est étude."],0,"Le verbe est étudier : elle étudie."],
["Quel métier utilise souvent un appareil photo ?",["Un photographe","Un boulanger","Un chauffeur"],0,"Un photographe prend des photos."],
["Complétez : Ma sœur est ___ et elle travaille dans un hôpital.",["infirmière","vendeuse","artiste"],0,"Le mot hôpital indique le domaine médical."],
["Quelle phrase précise une activité quotidienne ?",["Il prépare des dossiers le matin.","Il est très grand.","Il a les yeux verts."],0,"Préparer des dossiers est une activité; les autres phrases décrivent l’apparence."],
["Quelle phrase présente une personne de façon complète ?",["Elle est professeure, patiente et organisée.","Elle professeure patiente organisée.","Elle a professeure."],0,"La phrase combine profession et adjectifs avec être."],
["Pour demander la profession, on peut dire :",["Qu’est-ce que vous faites dans la vie ?","Où sont vos yeux ?","Quelle couleur est votre sac ?"],0,"Cette question sert à demander le métier ou l’activité principale."],
["Quelle réponse est naturelle ?",["Je suis étudiant et je travaille le week-end.","Je suis un étudiant et je suis travail.","J’ai étudiant et je fais week-end."],0,"La phrase utilise être pour l’identité et travailler pour l’activité."]
]));
C["present-progressif"]=A("Être en train de","Thème 6 · Description, professions et présent progressif","Grammaire en contexte","Utilisez le présent progressif pour décrire une action qui se passe maintenant.",from([
["Quelle phrase décrit une action en cours ?",["Elle est en train de lire.","Elle lit tous les jours.","Elle va lire demain."],0,"Être en train de + infinitif insiste sur l’action maintenant."],
["Complétez : Je suis en train ___ travailler.",["de","à","pour"],0,"La structure est être en train de + infinitif."],
["Devant une voyelle, on écrit :",["Je suis en train d’écouter.","Je suis en train de écouter.","Je suis en train écouter."],0,"De devient d’ devant une voyelle."],
["Choisissez la négation correcte.",["Il n’est pas en train de dormir.","Il ne pas est en train de dormir.","Il est en train de ne pas dormir."],0,"La négation encadre le verbe être : il n’est pas."],
["Quelle question est correcte ?",["Est-ce qu’elle est en train d’écrire ?","Est-ce elle en train écrit ?","Elle est-ce que de écrire ?"],0,"Question simple : est-ce que + sujet + être + en train de + infinitif."],
["Complétez : Nous ___ en train de parler.",["sommes","êtes","sont"],0,"Avec nous, le verbe être est sommes."],
["Complétez : Ils sont en train de ___.",["jouer","jouent","jouez"],0,"Après de, le verbe reste à l’infinitif."],
["Quelle phrase ne convient pas avec le présent progressif ?",["Elle est en train d’être médecin.","Elle est en train de téléphoner.","Elle est en train de travailler."],0,"Être médecin est une profession stable, pas une action en cours."],
["Quelle différence est correcte ?",["Je travaille = habitude ou situation; je suis en train de travailler = maintenant.","Je travaille = futur; je suis en train de travailler = passé.","Les deux phrases sont toujours impossibles."],0,"Le présent simple peut être général; le progressif insiste sur maintenant."],
["Transformez : Elle écrit un message maintenant.",["Elle est en train d’écrire un message.","Elle est en train écrit un message.","Elle a en train d’écrire un message."],0,"On conjugue être et on met le verbe principal à l’infinitif."],
["Complétez : Vous ___ en train de répondre.",["êtes","sommes","suis"],0,"Avec vous, le verbe être est êtes."],
["Quelle mini-description est correcte ?",["Sofia est photographe. Elle est en train de prendre une photo.","Sofia a photographe. Elle est train prend photo.","Sofia fait photographe. Elle être photo."],0,"La première phrase présente la profession puis l’action en cours."]
]));
...
const answerLayouts={
  ...
  "professions-activites":[1,2,0,2,1,0,1,2,0,2,1,0],
  "present-progressif":[2,0,1,2,1,0,2,1,0,1,2,0]
};
