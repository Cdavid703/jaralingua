(function () {
  ...
  window.quizCatalog = {
    ...
    "ecoute-nombres-1-20": A("Écoute : nombres de 1 à 20", "Thème 1 · Premiers contacts", "Compréhension orale", "Écoutez chaque nombre, puis choisissez sa forme écrite.", [
      Q("Quel nombre entendez-vous ?", ["sept", "seize", "dix-sept"], 0, "Vous avez entendu sept.", "../audio/theme-1/nombres/sept.mp3"),
      Q("Quel nombre entendez-vous ?", ["deux", "douze", "vingt"], 1, "Vous avez entendu douze.", "../audio/theme-1/nombres/douze.mp3"),
      Q("Quel nombre entendez-vous ?", ["cinq", "quinze", "seize"], 1, "Vous avez entendu quinze.", "../audio/theme-1/nombres/quinze.mp3"),
      Q("Quel nombre entendez-vous ?", ["neuf", "dix-neuf", "onze"], 1, "Vous avez entendu dix-neuf.", "../audio/theme-1/nombres/dix-neuf.mp3"),
      Q("Quel nombre entendez-vous ?", ["deux", "douze", "vingt"], 2, "Vous avez entendu vingt.", "../audio/theme-1/nombres/vingt.mp3")
    ]),
    ...
    "premiere-rencontre": A("Première rencontre", "Thème 1 · Premiers contacts", "Compréhension orale", "Écoutez le dialogue entre Lina et Thomas et repérez les informations importantes.", [
      Q("Comment s’appelle la première personne ?", ["Lina", "Sofia", "Laura"], 0, "Elle dit : Je m’appelle Lina.", "../audio/theme-1/dialogue-premiere-rencontre.mp3"),
    ...
    "conjugaison-er": A("Défi conjugaison -ER", "Thème 2 · Premier groupe", "Grammaire", "Choisissez la bonne terminaison au présent.", [
    ...
    "radical-terminaison": A("Radical + terminaison", "Thème 2 · Premier groupe", "Construction", "Identifiez le radical et construisez la forme correcte.", [
    ...
    "verbes-er-contexte": A("Verbes -ER en contexte", "Thème 2 · Premier groupe", "Lecture", "Complétez de petites routines au présent.", [
  ...
  function randomNumberQuestions() {
    ...
    return [...selected].map((number) => {
      ...
      return Q(
        ...
        `../audio/theme-1/nombres-1-100/nombre-${String(number).padStart(3,"0")}.mp3`
      );
    });
  }
