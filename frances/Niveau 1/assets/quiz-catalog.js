(function () {
  ...
  window.quizCatalog = {
    ...
    "ecoute-nombres-1-20": A("Écoute : nombres de 1 à 20", "Thème 1 · Premiers contacts", "Compréhension orale", "Écoutez chaque nombre, puis choisissez sa forme écrite.", [
      Q("Quel nombre entendez-vous ?", ["sept", "seize", "dix-sept"], 0, "Vous avez entendu sept.", "../audio/theme-1/nombres-verifies/sept.mp3?v=20260624-nombres-verifies"),
      Q("Quel nombre entendez-vous ?", ["deux", "douze", "vingt"], 1, "Vous avez entendu douze.", "../audio/theme-1/nombres-verifies/douze.mp3?v=20260624-nombres-verifies"),
      Q("Quel nombre entendez-vous ?", ["cinq", "quinze", "seize"], 1, "Vous avez entendu quinze.", "../audio/theme-1/nombres-verifies/quinze.mp3?v=20260624-nombres-verifies"),
      Q("Quel nombre entendez-vous ?", ["neuf", "dix-neuf", "onze"], 2, "Vous avez entendu onze.", "../audio/theme-1/nombres-verifies/onze.mp3?v=20260624-nombres-verifies"),
