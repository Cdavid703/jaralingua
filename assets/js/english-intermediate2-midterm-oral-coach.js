(() => {
  ...
  const turns = [
    ...
    { topic: "Catching up", prompt: "I know! Tell me, what have you been doing lately? Are you still in touch with anyone from school?", audio: "turn-2-catching-up.mp3", hint: "Lately, I have been working and studying. I still keep in touch with Laura.", reply: "That is lovely. It is strange how quickly time passes, but some friendships still feel familiar.", reaction: "reaction-2-catching-up.mp3" },
    ...
    { topic: "Your love-life dilemma", prompt: "And you? Are you facing any dilemma in your love life or relationships these days? You can tell me; I am your friend.", audio: "turn-5-your-dilemma.mp3", hint: "Actually, I am dealing with a difficult decision. I do not know whether I should continue this relationship.", reply: "Thank you for trusting me with that. Relationship dilemmas can be hard because feelings and practical choices are often mixed together.", reaction: "reaction-5-your-dilemma.mp3" },
  ...
  function resetAnswer() {
    ...
    recordingUrl = ""; chunks = [];
    ui.status.textContent = "Ready for your response";
    ...
    controls("Respond", false, false);
    setFloating("Ready to respond");
    stage("ready", "Mia is ready");
  }
  function renderTurn() {
