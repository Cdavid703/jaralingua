(() => {
  ...
  const STAGES = [
    { label: "Section 1", shortLabel: "1", audio: "audio/pronunciation/unit-4-intermediate/section-1.mp3", text: "The Riveras used to cook together every Sunday afternoon." },
    { label: "Section 2", shortLabel: "2", audio: "audio/pronunciation/unit-4-intermediate/section-2.mp3", text: "Now everyone has to help for twenty minutes before dinner." },
    { label: "Section 3", shortLabel: "3", audio: "audio/pronunciation/unit-4-intermediate/section-3.mp3", text: "Ana wants Leo to set the table, but Leo says the rule is not fair." },
    { label: "Section 4", shortLabel: "4", audio: "audio/pronunciation/unit-4-intermediate/section-4.mp3", text: "I understand your point, but we need a calm and realistic agreement." },
    { label: "Final challenge", shortLabel: "Final", final: true, audio: "audio/pronunciation/unit-4-intermediate/family-stories-model-us.mp3", text: "The Riveras used to cook together every Sunday afternoon. Now everyone has to help for twenty minutes before dinner. Ana wants Leo to set the table, but Leo says the rule is not fair. I understand your point, but we need a calm and realistic agreement." }
  ];

  const API_PATH = "/api/english-intermediate/pronunciation-assessment";
  const SUBMIT_PATH = "/api/intermediate/unit4-pronunciation/submit";
  const STORAGE_KEY = "jaralingua:english-intermediate:pronunciation-unit4:v1";
  const LOCAL_URL = "http://127.0.0.1:8020/ingles/intermediate/pronunciation-unit-4-family-stories.html";
      ...
      try {
        ...
        const response = await fetch(SUBMIT_PATH, {
          ...
          body: JSON.stringify({
            ...
            activityTitle: "Unit 4 Pronunciation - Family Stories",
