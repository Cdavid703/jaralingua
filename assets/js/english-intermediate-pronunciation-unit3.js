(() => {
  ...
  const STAGES = [
    { label: "Section 1", shortLabel: "1", audio: "audio/pronunciation/unit-3-intermediate/section-1.mp3", text: "The Grand Canyon is one of the most impressive natural wonders in the world." },
    { label: "Section 2", shortLabel: "2", audio: "audio/pronunciation/unit-3-intermediate/section-2.mp3", text: "It is deeper and wider than many visitors expect, and its colors change throughout the day." },
    { label: "Section 3", shortLabel: "3", audio: "audio/pronunciation/unit-3-intermediate/section-3.mp3", text: "Although the journey can be demanding, the view is unforgettable." },
    { label: "Section 4", shortLabel: "4", audio: "audio/pronunciation/unit-3-intermediate/section-4.mp3", text: "In my opinion, it is one of the best places to experience nature." },
    { label: "Final challenge", shortLabel: "Final", final: true, audio: "audio/pronunciation/unit-3-intermediate/unforgettable-natural-wonder-model-us.mp3", text: "The Grand Canyon is one of the most impressive natural wonders in the world. It is deeper and wider than many visitors expect, and its colors change throughout the day. Although the journey can be demanding, the view is unforgettable. In my opinion, it is one of the best places to experience nature." }
  ];

  const API_PATH = "/api/english-intermediate/pronunciation-assessment";
  const STORAGE_KEY = "jaralingua:english-intermediate:pronunciation-unit3:v1";
  const LOCAL_URL = "http://127.0.0.1:8020/ingles/intermediate/pronunciation-unit-3-unforgettable-natural-wonder.html";
  ...
  function pronunciationTip(word) {
    ...
    const special = {
      "grand": "Keep the final consonant group /nd/ clear: Grand /ɡrænd/.",
      "canyon": "Stress the first syllable and keep two clear parts: CAN-yon.",
      "impressive": "Stress the second syllable: im-PRES-sive.",
      "natural": "Stress the first syllable and keep the middle vowel light: NAT-u-ral.",
      "wonders": "Stress WON and finish with a clear z sound.",
      "world": "Keep the r-colored vowel and finish with the consonant group /rld/.",
      "deeper": "Use the long ee sound and finish with a smooth r: DEEP-er.",
      "wider": "Use the long i sound /aɪ/ and finish with a smooth r: WIDE-er.",
      "than": "Use the voiced th /ð/ by placing your tongue lightly between your teeth.",
      "visitors": "Stress the first syllable: VIS-i-tors.",
      "expect": "Stress the second syllable and keep the final t: ex-PECT.",
      "colors": "Stress the first syllable and finish with a smooth r plus z sound.",
      "throughout": "Use unvoiced th /θ/ and stress the second part: through-OUT.",
      "although": "Use voiced th /ð/ and stress the second syllable: al-THOUGH.",
      "journey": "Stress the first syllable and use a smooth r: JOUR-ney.",
      "demanding": "Stress the second syllable and finish with /ɪŋ/: de-MAND-ing.",
      "view": "Use the long /juː/ sound after v: view /vjuː/.",
      "unforgettable": "Stress GET and keep five clear parts: un-for-GET-ta-ble.",
      "opinion": "Stress the second syllable: o-PIN-ion.",
      "experience": "Stress the second syllable: ex-PE-ri-ence.",
      "nature": "Stress the first syllable and finish with a smooth r: NA-ture."
    };
