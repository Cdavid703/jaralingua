(() => {
  ...
  const STAGES = [
    { label: "Section 1", shortLabel: "1", audio: "audio/pronunciation/unit-2-intermediate/section-1.mp3", text: "I have always hoped to study abroad and experience a different culture." },
    { label: "Section 2", shortLabel: "2", audio: "audio/pronunciation/unit-2-intermediate/section-2.mp3", text: "If I had the opportunity, I would spend a year in Canada and improve my English." },
    { label: "Section 3", shortLabel: "3", audio: "audio/pronunciation/unit-2-intermediate/section-3.mp3", text: "Last summer, I finally traveled alone for the first time." },
    { label: "Section 4", shortLabel: "4", audio: "audio/pronunciation/unit-2-intermediate/section-4.mp3", text: "The experience was challenging, but it made me more independent and confident about my future." },
    { label: "Final challenge", shortLabel: "Final", final: true, audio: "audio/pronunciation/unit-2-intermediate/study-abroad-model-us.mp3", text: "I have always hoped to study abroad and experience a different culture. If I had the opportunity, I would spend a year in Canada and improve my English. Last summer, I finally traveled alone for the first time. The experience was challenging, but it made me more independent and confident about my future." }
  ];

  const API_PATH = "/api/english-intermediate/pronunciation-assessment";
  const STORAGE_KEY = "jaralingua:english-intermediate:pronunciation-unit2:v1";
  const LOCAL_URL = "http://127.0.0.1:8020/ingles/intermediate/pronunciation-unit-2-study-abroad.html";
  ...
  function pronunciationTip(word) {
    ...
    const special = {
      "always": "Keep the first syllable strong and the second one light: AL-ways.",
      "hoped": "Finish with a clear /t/ sound after hope: hoped /hoʊpt/.",
      "abroad": "Stress the second syllable: a-BROAD.",
      "experience": "Stress the second syllable: ex-PE-ri-ence.",
      "different": "Stress the first syllable and keep the middle light: DIF-fer-ent.",
      "culture": "Stress CUL and finish with a smooth r: CUL-ture.",
      "opportunity": "Stress TU and keep five syllables: op-por-TU-ni-ty.",
      "would": "The l is silent; say /wʊd/.",
      "canada": "Stress the first syllable: CAN-a-da.",
      "improve": "Stress the second syllable and use a clear v: im-PROVE.",
      "finally": "Stress the first syllable and keep -ly light: FI-nal-ly.",
      "traveled": "Use two syllables and finish with /d/: TRAV-eled.",
      "alone": "Stress the second syllable: a-LONE.",
      "challenging": "Stress the first syllable and keep the final ng sound: CHAL-len-ging.",
      "independent": "Stress PEN: in-de-PEN-dent.",
      "confident": "Stress the first syllable: CON-fi-dent.",
      "future": "Begin with /fjuː/ and finish with a smooth r: FU-ture."
    };
