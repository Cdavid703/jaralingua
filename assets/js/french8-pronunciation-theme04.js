(() => {
  ...
  const STAGES = [
    {
      label: "Section 1",
      shortLabel: "1",
      audio: "../audio/pronunciation/theme-04/section-1.mp3",
      text: "Lors de l’interview, la ministre a déclaré qu’elle présenterait son projet le lendemain."
    },
    {
      label: "Section 2",
      shortLabel: "2",
      audio: "../audio/pronunciation/theme-04/section-2.mp3",
      text: "Elle a expliqué que son équipe avait déjà consulté plusieurs associations."
    },
    {
      label: "Section 3",
      shortLabel: "3",
      audio: "../audio/pronunciation/theme-04/section-3.mp3",
      text: "Elle a ajouté qu’elle souhaitait encore écouter attentivement les habitants."
    },
    {
      label: "Section 4",
      shortLabel: "4",
      audio: "../audio/pronunciation/theme-04/section-4.mp3",
      text: "Enfin, elle a promis qu’aucune décision ne serait prise avant que tous les avis aient été examinés."
    },
    {
      label: "Défi final",
      shortLabel: "Défi",
      final: true,
      audio: "../audio/pronunciation/theme-04/n8-04d-discours-rapporte-modele-france.mp3",
      text: "Lors de l’interview, la ministre a déclaré qu’elle présenterait son projet le lendemain. Elle a expliqué que son équipe avait déjà consulté plusieurs associations. Elle a ajouté qu’elle souhaitait encore écouter attentivement les habitants. Enfin, elle a promis qu’aucune décision ne serait prise avant que tous les avis aient été examinés."
    }
  ];
  ...
  function normalizeWord(value) {
    ...
    const homophones = {
      ...
      "declarer": "declare",
      "presenterai": "presenterait",
      "expliquer": "explique",
      "consulter": "consulte",
      "ajouter": "ajoute",
      "souhaiter": "souhaitait",
      "ecouter": "ecouter",
      "promis": "promis",
      "examiner": "examines"
    };
  ...
  function pronunciationTip(word) {
    ...
    const special = {
      "l’interview": "Dites /lɛ̃tɛʁvju/ : gardez la voyelle nasale au début et terminez par /vju/.",
      "ministre": "Gardez deux groupes nets, mi-nistre, sans ajouter de voyelle après le r.",
      "déclaré": "Dites dé-cla-ré avec une finale fermée /e/.",
      "présenterait": "La terminaison -ait se prononce /ɛ/ : pré-sen-te-rait.",
      "lendemain": "La fin -main est nasale /mɛ̃/ ; ne prononcez pas le n séparément.",
      "expliqué": "Dites ex-pli-qué et terminez par le son fermé /e/.",
      "équipe": "Commencez par le son fermé /e/ et prononcez le groupe qui /kip/.",
      "associations": "Gardez cinq syllabes régulières et une fin nasale /sjɔ̃/.",
      "souhaitait": "Dites sou-hai-tait ; les deux dernières voyelles donnent le son ouvert /ɛ/.",
      "attentivement": "Gardez les groupes at-ten-ti-ve-ment et terminez par une voyelle nasale.",
      "habitants": "Dites ha-bi-tants sans aspirer le h et avec une fin nasale /tɑ̃/.",
      "qu’aucune": "Enchaînez qu’aucune sans pause : /kokyn/.",
      "serait": "La terminaison -ait se prononce /ɛ/ et le t final reste muet.",
      "avis": "Le s final est muet seul, mais faites l’enchaînement devant aient.",
      "aient": "Dans aient, la terminaison se prononce /ɛ/ ; le nt reste muet.",
      "examinés": "Dites ex-a-mi-nés et terminez par le son fermé /e/."
    };
