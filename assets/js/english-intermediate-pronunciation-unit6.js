(() => {
  ...
  const STAGES = [
    { label: "Section 1", shortLabel: "1", audio: "audio/pronunciation/unit-6-intermediate/section-1.mp3", text: "I am going to protect Saturday's recording and move the radio interview to Monday." },
    { label: "Section 2", shortLabel: "2", audio: "audio/pronunciation/unit-6-intermediate/section-2.mp3", text: "Olivia is meeting the producer on Tuesday, and the band is rehearsing on Wednesday." },
    { label: "Section 3", shortLabel: "3", audio: "audio/pronunciation/unit-6-intermediate/section-3.mp3", text: "Marcus says she should put off the photo session because it is still up in the air." },
    { label: "Section 4", shortLabel: "4", audio: "audio/pronunciation/unit-6-intermediate/section-4.mp3", text: "The updated schedule will free up Friday afternoon and keep everyone on the same page." },
    { label: "Final challenge", shortLabel: "Final", final: true, audio: "audio/pronunciation/unit-6-intermediate/future-plans-advice-model-us.mp3", text: "I am going to protect Saturday's recording and move the radio interview to Monday. Olivia is meeting the producer on Tuesday, and the band is rehearsing on Wednesday. Marcus says she should put off the photo session because it is still up in the air. The updated schedule will free up Friday afternoon and keep everyone on the same page." }
  ];

  const API_PATH = "/api/english-intermediate/pronunciation-assessment";
  const SUBMIT_PATH = "/api/intermediate/unit6-pronunciation/submit";
  const STORAGE_KEY = "jaralingua:english-intermediate:pronunciation-unit6:v1";
  const LOCAL_URL = "http://127.0.0.1:8020/ingles/intermediate/pronunciation-unit-6-future-plans-advice.html";
  ...
  function pronunciationTip(word) {
    ...
    const special = {
      "riveras": "Stress the second syllable clearly: Ri-VE-ras. Keep the final s light.",
      "used": "In used to, the phrase often sounds smooth: /yoostuh/. Do not add a strong d before to.",
      "cook": "Use one short vowel sound and finish with the /k/ clearly.",
      "together": "Stress the second syllable: to-GE-ther. Use a voiced th sound.",
      "sunday": "Stress the first syllable: SUN-day.",
      "afternoon": "Stress the last syllable: after-NOON.",
      "everyone": "Stress the first syllable: EV-ery-one.",
      "has": "In has to, connect it naturally: has to often sounds like /haztuh/.",
      "help": "Finish with the /lp/ consonant group without adding an extra vowel.",
      "twenty": "In American English, the middle t can be soft: TWEN-ee.",
      "minutes": "Stress the first syllable and keep the final s: MIN-utes.",
      "before": "Stress the second syllable: be-FORE.",
      "dinner": "Use a smooth American r at the end: DIN-ner.",
      "ana": "Keep two clear syllables: A-na.",
      "wants": "Finish the consonant group /nts/ clearly before Leo.",
      "leo": "Keep two open syllables: LE-o.",
      "set": "Short vowel, clear final t.",
      "table": "Stress the first syllable: TA-ble.",
      "rule": "Use a long vowel and a smooth r: rule.",
      "fair": "Use a clear air-like vowel sound and do not make it two separate words.",
      "understand": "Stress the last syllable: under-STAND.",
      "point": "Finish with the /nt/ consonant group.",
      "calm": "The l is usually silent; say /kaam/ with one long vowel.",
      "realistic": "Stress the third syllable: rea-LIS-tic.",
      "agreement": "Stress the second syllable: a-GREE-ment."
    };
    Object.assign(special, {
      "going": "Keep it smooth: go-ing. In connected speech, going to often sounds lighter, but the word going must still be clear.",
      "protect": "Stress the second syllable: pro-TECT. Finish the final /t/ lightly.",
      "saturday": "Use three syllables in natural American English: SAT-er-day.",
      "recording": "Stress the second syllable: re-CORD-ing. Finish with the ng sound.",
      "radio": "Keep three open syllables: RAY-dee-oh.",
      "interview": "Stress the first syllable: IN-ter-view. Do not add an extra syllable at the end.",
      "monday": "Stress the first syllable: MON-day.",
      "olivia": "Keep four clear syllables: o-LIV-ee-a.",
      "meeting": "Stress the first syllable and finish with ng: MEET-ing.",
      "producer": "Stress the second syllable: pro-DU-cer. Use a smooth final r.",
      "tuesday": "Say it clearly as TOOZ-day in American English.",
      "band": "Finish with the /nd/ consonant group.",
      "rehearsing": "Stress the second syllable: re-HEARS-ing. Keep the r smooth.",
      "wednesday": "Say two syllables: WENZ-day.",
      "marcus": "Stress the first syllable: MAR-cus.",
      "says": "Use the /sez/ pronunciation, not a long ay sound.",
      "should": "Use the /sh/ sound and do not pronounce the l.",
      "put": "Use the short vowel in put. Do not say it like putt.",
      "off": "Open the vowel and connect put off without a long pause.",
      "photo": "Stress the first syllable: PHO-to.",
      "session": "Stress the first syllable and finish with /shun/: SES-sion.",
      "because": "Reduce the first syllable lightly, then stress CAUSE.",
      "still": "Finish the final /l/ clearly.",
      "air": "Use one smooth vowel sound with a final r.",
      "updated": "Stress the second syllable: up-DAY-ted.",
      "schedule": "In American English, say SKEH-jool.",
      "free": "Hold the long vowel and keep the /r/ smooth.",
      "friday": "Stress the first syllable: FRI-day.",
      "afternoon": "Stress the last syllable: after-NOON.",
      "everyone": "Use three syllables: EV-ree-one.",
      "same": "Hold the long vowel and connect same page.",
      "page": "Finish with the soft /j/ sound."
    });
  ...
  function createSubmitPanel() {
    ...
    function update() {
      ...
      if (!attempt || !Number.isFinite(score)) {
        ...
        panel.querySelector(".unit6-delivery-preview")?.remove();
      ...
      preview.className = "unit6-delivery-preview";
      preview.innerHTML = `<p><strong>Delivery preview</strong></p><p><span>Audio duration:</span> ${formatTime(recordedDurationMs)}</p><p><span>Text read:</span> ${attempt.referenceText}</p><p><span>Gradebook:</span> follow-up activity, weight 0, visible to teacher.</p>`;
      ...
      try {
        ...
        const response = await fetch(SUBMIT_PATH, {
          ...
          body: JSON.stringify({
            ...
            activityTitle: "Unit 6 Pronunciation - Future Plans and Advice",
            details: Object.assign({}, attempt, { audioDataUrl })
          })
        });
        const payload = await response.json().catch(() => ({}));
        if (!response.ok) {
          if (payload.error === "student_not_authorized") throw new Error("This account is not linked to an Intermediate English student record.");
