(() => {
  ...
  const STAGES = [
  {
    "label": "Section 1 - People and feelings",
    "shortLabel": "1",
    "audio": "audio/unit5/pronunciation/section-1.mp3",
    "text": "I was tired yesterday. She was happy. We were ready. They were excited."
  },
  {
    "label": "Section 2 - Negative forms",
    "shortLabel": "2",
    "audio": "audio/unit5/pronunciation/section-2.mp3",
    "text": "I wasn't angry. He wasn't at home. We weren't late. They weren't scared."
  },
  {
    "label": "Section 3 - Questions and short answers",
    "shortLabel": "3",
    "audio": "audio/unit5/pronunciation/section-3.mp3",
    "text": "Were you at school? Yes, I was. Was she worried? No, she wasn't."
  },
  {
    "label": "Section 4 - Past places",
    "shortLabel": "4",
    "audio": "audio/unit5/pronunciation/section-4.mp3",
    "text": "There was a quiet cottage. There were three chairs. The rooms were empty."
  },
  {
    "label": "Section 5 - Past actions and phrasal verbs",
    "shortLabel": "5",
    "audio": "audio/unit5/pronunciation/section-5.mp3",
    "text": "I went back home. We got over our fear. We visited our friends."
  },
  {
    "label": "Section 6 - Memories and idioms",
    "shortLabel": "6",
    "audio": "audio/unit5/pronunciation/section-6.mp3",
    "text": "It was a blast from the past. It was a trip down memory lane."
  },
  {
    "label": "Final challenge",
    "shortLabel": "Final",
    "final": true,
    "audio": "audio/unit5/pronunciation/final-challenge.mp3",
    "text": "I was tired yesterday. She was happy. We were ready. They were excited. I wasn't angry. He wasn't at home. We weren't late. They weren't scared. Were you at school? Yes, I was. Was she worried? No, she wasn't. There was a quiet cottage. There were three chairs. The rooms were empty. I went back home. We got over our fear. We visited our friends. It was a blast from the past. It was a trip down memory lane."
  }
];
  ...
  const SUBMIT_PATH = "/api/basic2/unit5-looking-back-pronunciation/submit";
  const STORAGE_KEY = "jaralingua:english-basic2:pronunciation-unit5-looking-back:v1";
  const SUBMISSION_KEY = "jaralingua:english-basic2:pronunciation-unit5-looking-back:submission:v1";
  const LOCAL_URL = "http://127.0.0.1:8020/ingles/basico-2/pronunciation-unit-5-looking-back.html";
  ...
  function pronunciationTip(word) {
    ...
    if (w === "was" || w === "wasn't") return "Listen to /w/ and the voiced /z/ in was. In wasn't, keep the negative ending audible.";
    if (w === "were" || w === "weren't") return "Listen to the American English /r/ in were. Keep weren't distinct from were.";
    if (w === "visited") return "Visited has an extra /ɪd/ syllable at the end.";
    if (w === "went" || w === "got") return "Keep the final /t/ clear, then connect smoothly to the next word.";
    return "Listen to the word, repeat it, then read it again in its sentence.";
  }
  ...
  function speakWord(word) {
    ...
    wordAudio = new Audio(`audio/unit5/pronunciation/words/${slug}.mp3`);
    wordAudio.preload = "auto";
    wordAudio.playbackRate = currentPlaybackRate();
    let failed = false;
  ...
  function setPlaybackRate(rate) {
    ...
    if (wordAudio) wordAudio.playbackRate = rate;
  ...
  async function boundedFetch(url, options, milliseconds) {
    ...
    try {
      ...
      if (error.name === "AbortError") throw new Error("The connection took too long. Your progress is saved. Please try again.");
      throw error;
  ...
  async function transcribeAndEvaluate(blob) {
    ...
    recordStatus.textContent = "Analyzing your English recording...";
    liveTranscript.textContent = "Transcribing...";
    try {
      const { response, payload } = await boundedFetch(API_PATH, { method: "POST", headers: { "Content-Type": blob.type || "audio/webm" }, body: blob }, 120000);
  ...
  function createSubmitPanel() {
    ...
    function update() {
      ...
      if (!report) {
        ...
        if (submitState !== "submitted" && submitState !== "error") {
          setStatus("Complete the 6 guided sections and the final challenge first. Then this button will unlock so you can send the report to the teacher.", "pending");
        }
        return;
      }
    ...
    async function submit() {
      ...
      update();
      try {
        const { response, payload } = await boundedFetch(SUBMIT_PATH, {
          method: "POST",
          headers: {
          ...
          body: JSON.stringify({
            ...
            activityTitle: "Basic 2 Unit 5 Pronunciation - Looking Back",
