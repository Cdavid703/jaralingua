(() => {
  ...
  const STAGES = [
    { label: "Section 1 - Shopping words", shortLabel: "1", audio: "audio/unit2/pronunciation/section-1-shopping-words.mp3", text: "jacket, jeans, sweater, sunglasses, tickets, posters." },
    { label: "Section 2 - Clothes and accessories", shortLabel: "2", audio: "audio/unit2/pronunciation/section-2-clothes-and-accessories.mp3", text: "blue jacket, gray sweater, black pants, cool sunglasses, concert tickets." },
    { label: "Section 3 - Demonstratives", shortLabel: "3", audio: "audio/unit2/pronunciation/section-3-demonstratives.mp3", text: "This blue jacket fits well. That entrance is across the street. These tickets are correct. Those posters are behind Noah." },
    { label: "Section 4 - Concert locations", shortLabel: "4", audio: "audio/unit2/pronunciation/section-4-concert-locations.mp3", text: "We are near the ticket line. Noah is near the coffee stand. The doors are over there. The concert starts in ten minutes." },
    { label: "Section 5 - Current actions", shortLabel: "5", audio: "audio/unit2/pronunciation/section-5-current-actions.mp3", text: "Lucas is checking his phone. Sofia is wearing a blue jacket. Noah is walking across the street. He is waving at them." },
    { label: "Section 6 - Story sentences", shortLabel: "6", audio: "audio/unit2/pronunciation/section-6-story-sentences.mp3", text: "The jacket, the message, and the tickets all helped. Now they are ready for the concert." },
    { label: "Final challenge", shortLabel: "Final", final: true, audio: "audio/unit2/pronunciation/final-challenge-shopping-concert.mp3?v=20260728-full-challenge", text: "jacket, jeans, sweater, sunglasses, tickets, posters. blue jacket, gray sweater, black pants, cool sunglasses, concert tickets. This blue jacket fits well. That entrance is across the street. These tickets are correct. Those posters are behind Noah. We are near the ticket line. Noah is near the coffee stand. The doors are over there. The concert starts in ten minutes. Lucas is checking his phone. Sofia is wearing a blue jacket. Noah is walking across the street. He is waving at them. The jacket, the message, and the tickets all helped. Now they are ready for the concert." }
  ];

  const GUIDED_COUNT = 6;
  const FINAL_INDEX = STAGES.length - 1;
  const API_PATH = "/api/english-basic/pronunciation-assessment";
  const SUBMIT_PATH = "/api/basic/basic2-unit2-pronunciation-shopping-concert/submit";
  const STORAGE_KEY = "jaralingua:english-basic2:pronunciation-unit2-shopping-concert:v1";
  const SUBMISSION_KEY = "jaralingua:english-basic2:pronunciation-unit2-shopping-concert:submission:v1";
  const LOCAL_URL = "http://127.0.0.1:8020/ingles/basico-2/pronunciation-unit-2-shopping-concert.html";
  ...
  function pronunciationTip(word) {
    ...
    const special = {
      "jacket": "Stress the first syllable: JAC-ket. Keep the final t light.",
      "jeans": "Hold the long ee sound and finish with the z sound: jeans.",
      "sweater": "Say two clear syllables: SWE-ter. Keep the final r smooth.",
      "sunglasses": "Stress SUN and GLASS: SUN-glass-es. Finish the plural sound clearly.",
      "tickets": "Stress the first syllable: TICK-ets. Finish with the /ts/ sound.",
      "posters": "Stress the first syllable: PO-sters. Keep the final r smooth.",
      "blue": "Use one long vowel sound: blue.",
      "gray": "Use one clear long vowel sound: gray.",
      "pants": "Finish the /nts/ consonant group clearly.",
      "cool": "Hold the long oo sound: cool.",
      "concert": "American English often stresses the first syllable: CON-cert.",
      "this": "Use the voiced th sound. Put the tongue lightly between the teeth.",
      "that": "Use the voiced th sound, then a short a sound.",
      "these": "Use voiced th and finish with a z sound.",
      "those": "Use voiced th and finish with a z sound.",
      "fits": "Finish the /ts/ consonant group clearly.",
      "well": "Start with a clear w sound and finish with l.",
      "entrance": "Stress the first syllable: EN-trance.",
      "across": "Stress the second syllable: a-CROSS.",
      "street": "Start with the /str/ consonant group and hold the long ee sound.",
      "correct": "Stress the second syllable: cor-RECT.",
      "behind": "Stress the second syllable: be-HIND.",
      "noah": "Say two smooth syllables: NO-ah.",
      "near": "Use the vowel sound in ear and keep the r smooth.",
      "coffee": "Stress the first syllable: COF-fee.",
      "stand": "Keep the /st/ sound at the beginning and the d at the end.",
      "doors": "Hold the vowel and finish with a smooth z/r sound.",
      "starts": "Finish the /rts/ group clearly.",
      "minutes": "Stress the first syllable: MIN-utes.",
      "lucas": "Say two clear syllables: LU-cas.",
      "checking": "Stress the first syllable and finish with ng: CHECK-ing.",
      "phone": "Hold the long o sound.",
      "sofia": "Keep three clear syllables: so-FI-a.",
      "wearing": "Stress WEAR and finish with the ng sound.",
      "walking": "Stress WALK and finish with the ng sound.",
      "waving": "Stress WAV and finish with the ng sound.",
      "message": "Stress the first syllable: MES-sage.",
      "helped": "The -ed ending sounds like /t/: helped.",
      "ready": "Stress the first syllable: REA-dy."
    };
    ...
    if (/^th/.test(lower)) return "Use the voiced th sound for this unit's demonstratives: this, that, these, those.";
      ...
      try {
        const response = await fetch(SUBMIT_PATH, {
          ...
          body: JSON.stringify({
            ...
            activityTitle: "Basic 2 Unit 2 Pronunciation - Shopping and Concert",
