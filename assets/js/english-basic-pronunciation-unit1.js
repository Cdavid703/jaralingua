(() => {
  ...
  const STAGES = [
    { label: "Section 1", shortLabel: "1", audio: "audio/pronunciation/unit-1/section-1.mp3", text: "Hello, my name is Maya, and I am twenty-four years old." },
    { label: "Section 2", shortLabel: "2", audio: "audio/pronunciation/unit-1/section-2.mp3", text: "I am from Colombia, but I live in Boston now." },
    { label: "Section 3", shortLabel: "3", audio: "audio/pronunciation/unit-1/section-3.mp3", text: "I am a graphic design student, and I enjoy music and photography." },
    { label: "Section 4", shortLabel: "4", audio: "audio/pronunciation/unit-1/section-4.mp3", text: "It is nice to meet you, and I am happy to practice English with you." },
    { label: "Final challenge", shortLabel: "Final", final: true, audio: "audio/pronunciation/unit-1/introducing-myself-model-us.mp3", text: "Hello, my name is Maya, and I am twenty-four years old. I am from Colombia, but I live in Boston now. I am a graphic design student, and I enjoy music and photography. It is nice to meet you, and I am happy to practice English with you." }
  ];

  const API_PATH = "/api/english-basic/pronunciation-assessment";
  const STORAGE_KEY = "jaralingua:english-basic:pronunciation-unit1:v1";
  const LOCAL_URL = "http://127.0.0.1:8020/ingles/basico/pronunciation-unit-1-introducing-myself.html";
  ...
  function normalizeWord(value) {
    ...
    if (lower === "24") return "twenty-four";
    if (lower === "columbia") return "colombia";
  ...
  function pronunciationTip(word) {
    ...
    const special = {
      "hello": "Let the h sound out gently, then stress the second syllable: he-LO.",
      "maya": "Say MY-uh in two clear syllables.",
      "twenty-four": "Keep both parts clear: TWEN-ty FOUR.",
      "colombia": "Stress the second syllable: co-LOM-bi-a.",
      "boston": "Stress the first syllable and keep the final n light: BOS-ton.",
      "graphic": "Stress the first syllable: GRA-phic.",
      "photography": "Stress the second syllable: pho-TOG-ra-phy.",
