(function () {
  ...
  var DATA = window.JaraLinguaHangmanB1 || { categories: [] };
  var STORAGE_KEY = "french7-hangman-game-v1";
  var SOUND_KEY = "french7-hangman-sound-v1";
  ...
  function categoryLabel(id) {
    if (id === "all") return "Mélange B1/B1+";
    var category = (DATA.categories || []).filter(function (item) { return item.id === id; })[0];
    return category ? category.label : "Catégorie B1/B1+";
  }
