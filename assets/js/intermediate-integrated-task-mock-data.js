window.INTERMEDIATE_INTEGRATED_TASK_MOCK = {
  ...
  questions: [
    {
      id: "m1",
      prompt: "What is the main purpose of the Food Passport episode?",
      options: [
        "To teach three complete recipes",
        "To compare snacks, occasions, and food-review evidence",
    ...
    {
      id: "m4",
      prompt: "What are the sweet rice cakes made with?",
      options: [
    ...
    {
      id: "m8",
      prompt: "Which texture contrast describes the Brazilian cheese bread?",
      options: [
        "Cold outside and dry inside",
        "Sticky outside and hard inside",
