window.JaraLinguaScheduleCoachConfig = {
  ...
  ui: {
    ...
    deliveryIncompleteStatus: "This report has {analyzed} of {total} analyzed stages. You can send it now; missing stages count as 0 in the official reference grade.",
    deliveryIncompleteToast: "Partial partner report ready to send. Missing stages will be visible to the teacher.",
    ...
    deliverySuccessStatus: "Submitted to teacher. Reference grade: {grade}/5. Gradebook weight: 20%. This result affects your accumulated course average.",
    deliverySuccessToast: "Submitted to teacher. Reference grade recorded with weight 20%.",
    deliveryIncompleteServer: "The server could not save this partner report. Try signing in again or refresh the page.",
