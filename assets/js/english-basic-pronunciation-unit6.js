(() => {
  ...
  const STAGES = [
    { label: "Section 1", shortLabel: "1", audio: "audio/pronunciation/unit-6/section-1.mp3", text: "In my neighborhood, there is a quiet park near my house." },
    { label: "Section 2", shortLabel: "2", audio: "audio/pronunciation/unit-6/section-2.mp3", text: "There are two cafes and a supermarket next to the bus stop." },
    { label: "Section 3", shortLabel: "3", audio: "audio/pronunciation/unit-6/section-3.mp3", text: "The library opens at eight, and I study there after class." },
    { label: "Section 4", shortLabel: "4", audio: "audio/pronunciation/unit-6/section-4.mp3", text: "My favorite place is the bakery because it is friendly and clean." },
    { label: "Final challenge", shortLabel: "Final", final: true, audio: "audio/pronunciation/unit-6/my-neighborhood-model-us.mp3", text: "In my neighborhood, there is a quiet park near my house. There are two cafes and a supermarket next to the bus stop. The library opens at eight, and I study there after class. My favorite place is the bakery because it is friendly and clean." }
  ];

  const API_PATH = "/api/english-basic/pronunciation-assessment";
  const STORAGE_KEY = "jaralingua:english-basic:pronunciation-unit6:v1";
  const LOCAL_URL = "http://127.0.0.1:8020/ingles/basico/pronunciation-unit-6-my-neighborhood.html";
  ...
  function pronunciationTip(word) {
    ...
    const special = {
      "neighborhood": "Stress the first syllable and connect the middle smoothly: NEIGH-bor-hood.",
      "there": "Use the voiced th sound and a smooth American r.",
      "quiet": "Keep two clear syllables: QUI-et.",
      "park": "Use a strong American r before the final k: park.",
      "house": "Start with a clear h sound and finish with final s.",
      "cafes": "Stress the second syllable: ca-FES, and finish with a z sound.",
      "supermarket": "Stress the first syllable and keep four parts: SU-per-mar-ket.",
      "next": "Finish the consonant group clearly: next.",
      "bus": "Use a short u sound and finish with s.",
      "stop": "Finish with a clear final p; do not add another vowel.",
      "library": "Stress the first syllable: LI-brary.",
      "opens": "The final s sounds like z: opens.",
      "eight": "Begin with the long a sound and finish with a clear final t.",
      "study": "Stress the first syllable: STU-dy.",
      "favorite": "Stress the first syllable: FAY-vor-ite.",
      "place": "Use the long a sound and finish with final s.",
      "bakery": "Stress the first syllable: BA-kery.",
      "because": "In careful speech, stress the second syllable: be-CAUSE.",
      "friendly": "Keep the consonant group fr clear: FRIEND-ly.",
      "clean": "Use the long ee sound and finish with final n.",
      "after": "Use the short a sound /æ/ and finish with a smooth American r: AF-ter.",
      "usually": "Stress the first syllable and keep the middle /ʒ/ sound: U-su-al-ly.",
      "relax": "Stress the second syllable: re-LAX.",
      "watch": "Finish with the ch sound /tʃ/ without adding another vowel.",
      "funny": "Stress the first syllable and keep the short u sound: FUN-ny.",
      "series": "Stress the first syllable and keep two clear parts: SE-ries.",
      "often": "In common American pronunciation, the t is usually silent: OF-en.",
      "listen": "The t is silent; say LIS-en.",
      "music": "Stress the first syllable: MU-sic.",
      "chat": "Begin with ch /tʃ/ and finish with a clear final t.",
      "online": "Stress the first syllable and connect both parts: ON-line.",
      "fridays": "Stress the first syllable and keep the final z sound: FRI-days.",
      "sometimes": "Stress the first syllable and keep the final z sound.",
      "coffee": "Stress the first syllable: COF-fee.",
      "cook": "Use the short vowel /ʊ/, different from the long vowel in food.",
      "together": "Stress the second syllable: to-GE-ther, with a voiced th /ð/.",
      "rarely": "Stress the first syllable and use a smooth English r: RARE-ly.",
      "video": "Stress the first syllable and keep three clear parts: VID-e-o.",
      "games": "The final s sounds like /z/: games /geɪmz/.",
      "helps": "Finish with the consonant group /lps/ and a clear final s.",
