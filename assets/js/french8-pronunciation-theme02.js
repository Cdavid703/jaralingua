(() => {
  ...
  const STAGES = [
    ...
    },
    {
      label: "Section 3",
      shortLabel: "3",
      audio: "../audio/pronunciation/theme-02/section-3.mp3",
      text: "Avec le recul, je me dis que certaines décisions auraient radicalement changé notre histoire,"
    },
    {
      label: "Section 4",
      shortLabel: "4",
      audio: "../audio/pronunciation/theme-02/section-4.mp3",
      text: "même si nous n’en comprenions pas immédiatement les conséquences."
    },
    {
      label: "Défi final",
      shortLabel: "Défi",
  ...
  const STORAGE_KEY = "jaralingua:french8:pronunciation-02d:v1";
  const GRADE_SUBMISSION = {
    evaluationId: "pronunciation02d",
    title: "Prononciation 02D - Hypothèses irréelles"
  };
  const LOCAL_URL = "http://127.0.0.1:8020/frances/Niveau%208/ateliers/prononciation-02d-hypotheses-irreelles-passe.html";
  ...
  function pronunciationTip(word) {
    ...
    const special = {
      "j’étais": "Dites /ʒetɛ/ : le son final est ouvert /ɛ/, sans prononcer le s.",
      "j’aurais": "Dites /ʒɔʁɛ/ : gardez le r français et terminez par le son ouvert /ɛ/.",
      "train": "La fin ain forme la voyelle nasale /ɛ̃/ : ne prononcez pas le n séparément.",
      "imprévu": "Enchaînez les trois syllabes im-pré-vu et terminez par le son u /y/.",
      "peut-être": "Dans peut, arrondissez les lèvres pour /ø/ ; dans être, ouvrez pour /ɛ/.",
      "l’accident": "Dites /laksidɑ̃/ : le t final reste muet et la dernière voyelle est nasale.",
      ...
      "conséquences": "Gardez trois groupes nets : con-sé-quences, avec la première voyelle nasale."
    };
