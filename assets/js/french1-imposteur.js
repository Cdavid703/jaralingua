(function () {
  ...
  function renderVote(payload) {
    ...
    if (player.hasVoted) {
      setHtml("#votePanel", '<section class="vote-box"><img src="../img/jeux/imposteur-a1-vote.png" alt="Vote envoyé"><div><h3>Vote envoyé</h3><p>Ton vote est enregistré. Attends la révélation du professeur.</p></div></section>');
      return;
    }
