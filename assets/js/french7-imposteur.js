(function () {
  ...
  var API = "/api/french7/imposteur";
  var STATE_API = "/api/french7/imposteur/state";
  var STORAGE_KEY = "french7-imposteur-live-state";
  var SOUND_STORAGE_KEY = "french7-imposteur-sound-enabled";
  var POLL_MS = 1800;
  var QR_VERSION = 3;
  var QR_SIZE = 29;
  ...
  function waitingRoleMarkup() {
    return '<article class="private-card waiting">' +
      '<img src="../img/jeux/jeu-imposteur-role-citoyen.png" alt="Carte privée en attente">' +
  ...
  function renderRole(payload) {
    ...
    if (player.role === "impostor" && room.status !== "waiting") {
      setHtml("#roleCard", '<article class="private-card impostor">' +
        '<img src="../img/jeux/jeu-imposteur-role-imposteur.png" alt="Carte privée imposteur">' +
    ...
    if (player.role === "citizen" && player.card && room.status !== "waiting") {
      ...
      setHtml("#roleCard", '<article class="private-card citizen">' +
        '<img src="../img/jeux/jeu-imposteur-role-citoyen.png" alt="Carte privée joueur">' +
  ...
  function renderVote(payload) {
    ...
    if (player.hasVoted) {
      setHtml("#votePanel", '<section class="vote-box"><img src="../img/jeux/jeu-imposteur-vote.png" alt="Vote envoyé"><div><h3>Vote envoyé</h3><p>Ton vote est enregistré. Attends la révélation du professeur.</p></div></section>');
      return;
    }
