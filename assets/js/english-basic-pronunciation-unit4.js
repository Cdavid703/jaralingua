(() => {
  ...
  const STAGES = [
    { label: "Section 1", shortLabel: "1", audio: "audio/pronunciation/unit-4/section-1.mp3", text: "On weekdays, I usually wake up at six thirty and drink a glass of water." },
    { label: "Section 2", shortLabel: "2", audio: "audio/pronunciation/unit-4/section-2.mp3", text: "I brush my teeth, eat a healthy breakfast, and walk to work." },
    { label: "Section 3", shortLabel: "3", audio: "audio/pronunciation/unit-4/section-3.mp3", text: "In the evening, I sometimes exercise or play basketball with friends." },
    { label: "Section 4", shortLabel: "4", audio: "audio/pronunciation/unit-4/section-4.mp3", text: "I go to bed early because good sleep helps me feel strong." },
    { label: "Final challenge", shortLabel: "Final", final: true, audio: "audio/pronunciation/unit-4/my-healthy-day-model-us.mp3", text: "On weekdays, I usually wake up at six thirty and drink a glass of water. I brush my teeth, eat a healthy breakfast, and walk to work. In the evening, I sometimes exercise or play basketball with friends. I go to bed early because good sleep helps me feel strong." }
  ];

  const API_PATH = "/api/english-basic/pronunciation-assessment";
  const STORAGE_KEY = "jaralingua:english-basic:pronunciation-unit4:v1";
  const LOCAL_URL = "http://127.0.0.1:8020/ingles/basico/pronunciation-unit-4-my-healthy-day.html";
  ...
  function pronunciationTip(word) {
    ...
    const special = {
      "weekdays": "Stress the first syllable and keep the final z sound: WEEK-days.",
      "usually": "Stress the first syllable and keep the middle /ʒ/ sound: U-su-al-ly.",
      "wake": "Use the long a sound /eɪ/ and connect wake up smoothly.",
      "thirty": "Place your tongue between your teeth for the unvoiced th /θ/.",
      "drink": "Finish with the consonant group /ŋk/ without adding a vowel.",
      "water": "Use the American flap sound in the middle and finish with a smooth r.",
      "brush": "Begin with br and finish with the sh sound /ʃ/.",
      "teeth": "Use the long ee sound and finish with the unvoiced th /θ/.",
      "healthy": "Use the unvoiced th /θ/ and stress the first syllable: HEALTH-y.",
      "breakfast": "Stress the first syllable: BREAK-fast.",
      "walk": "The l is silent; say /wɔk/ with one clear syllable.",
      "evening": "Stress the first syllable and keep three clear parts: EVE-ning.",
      "sometimes": "Stress the first syllable and keep the final z sound.",
      "exercise": "Stress the first syllable and finish with the z sound: EX-er-cise.",
      "basketball": "Stress BAS and connect the three parts smoothly: BAS-ket-ball.",
      "because": "Stress the second syllable: be-CAUSE.",
      "helps": "Finish with the consonant group /lps/ and a clear final s.",
      "strong": "Begin with the consonant group str and finish with /ŋ/."
    };
