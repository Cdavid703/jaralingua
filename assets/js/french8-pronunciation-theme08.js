(() => {
  ...
  const STAGES = [
    {
      label: "Section 1",
      shortLabel: "1",
      audio: "../audio/pronunciation/theme-08/section-1.mp3",
      text: "A l'oral, je dis souvent : j'sais pas, y'a du bruit, t'as deux minutes ?"
    },
    {
      label: "Section 2",
      shortLabel: "2",
      audio: "../audio/pronunciation/theme-08/section-2.mp3",
      text: "En registre soutenu, je dirais plutot : pourriez-vous m'accorder un instant ?"
    },
    {
      label: "Section 3",
      shortLabel: "3",
      audio: "../audio/pronunciation/theme-08/section-3.mp3",
      text: "Le verlan change le rythme : c'est ouf, c'est chelou, parfois c'est relou."
    },
    {
      label: "Section 4",
      shortLabel: "4",
      audio: "../audio/pronunciation/theme-08/section-4.mp3",
      text: "Mais le bon registre au bon moment, c'est la cle pour rester clair."
    },
    {
      label: "Defi final",
      shortLabel: "Defi",
      final: true,
      audio: "../audio/pronunciation/theme-08/n8-08d-francais-oral-modele-france.mp3",
      text: "A l'oral, je dis souvent : j'sais pas, y'a du bruit, t'as deux minutes ? En registre soutenu, je dirais plutot : pourriez-vous m'accorder un instant ? Le verlan change le rythme : c'est ouf, c'est chelou, parfois c'est relou. Mais le bon registre au bon moment, c'est la cle pour rester clair."
    }
  ];

  const API_PATH = "/api/french8/pronunciation-assessment";
  const STORAGE_KEY = "jaralingua:french8:pronunciation-08d:v1";
  const GRADE_SUBMISSION = {
    evaluationId: "pronunciation08d",
    title: "Prononciation 08D - Francais oral authentique"
  };
  const LOCAL_URL = "http://127.0.0.1:8020/frances/Niveau%208/ateliers/prononciation-08d-francais-oral.html";
  ...
  function pronunciationTip(word) {
    ...
    const special = {
      "bien": "Gardez bien la voyelle nasale de bien, sans prononcer le n final.",
      "ascenseur": "Enchainez les trois syllabes : a-scen-seur.",
      "social": "Ne coupez pas entre ascenseur et social.",
      "panne": "Prononcez panne clairement, sans allonger la consonne finale.",
      "baisser": "La finale -er se prononce /e/.",
      "bras": "Le s final de bras reste muet.",
      "meme": "Gardez le son ouvert et une intonation de concession.",
      "obstacles": "Prononcez le groupe initial ob- sans ajouter de voyelle.",
      "initiatives": "Gardez un rythme regulier : i-ni-tia-tives.",
      "quoique": "Enchainez quoique avec le groupe suivant sans pause excessive.",
      "resultats": "Le t et le s finals de resultats restent muets.",
      "citoyen": "Gardez la voyelle nasale finale.",
      "malgre": "Ouvrez la derniere voyelle et gardez le r doux.",
      "plafond": "Gardez le son nasal de plafond.",
      "verre": "Le r final doit rester doux, au fond de la gorge.",
      "egalite": "Marquez les quatre syllabes : e-ga-li-te."
    };
