  ...
  const STAGES = [
    {
      label: "Section 1",
      shortLabel: "1",
      audio: "../audio/pronunciation/theme-07/section-1.mp3",
      text: "Bien que l'ascenseur social semble en panne, il ne faut pas baisser les bras."
    },
    {
      label: "Section 2",
      shortLabel: "2",
      audio: "../audio/pronunciation/theme-07/section-2.mp3",
      text: "Meme si les obstacles sont nombreux, certaines initiatives ouvrent des portes."
    },
    {
      label: "Section 3",
      shortLabel: "3",
      audio: "../audio/pronunciation/theme-07/section-3.mp3",
      text: "Quoique les resultats soient encore limites, le debat citoyen avance."
    },
    {
      label: "Section 4",
      shortLabel: "4",
      audio: "../audio/pronunciation/theme-07/section-4.mp3",
      text: "Malgre le plafond de verre, des parcours inspirants montrent que l'egalite reste un combat."
    },
    {
      label: "Defi final",
      shortLabel: "Defi",
      final: true,
      audio: "../audio/pronunciation/theme-07/n8-07d-justice-sociale-modele-france.mp3",
      text: "Bien que l'ascenseur social semble en panne, il ne faut pas baisser les bras. Meme si les obstacles sont nombreux, certaines initiatives ouvrent des portes. Quoique les resultats soient encore limites, le debat citoyen avance. Malgre le plafond de verre, des parcours inspirants montrent que l'egalite reste un combat."
    }
  ];

  const API_PATH = "/api/french8/pronunciation-assessment";
  const STORAGE_KEY = "jaralingua:french8:pronunciation-07d:v1";
  const GRADE_SUBMISSION = {
    evaluationId: "pronunciation07d",
    title: "Prononciation 07D - Justice sociale et citoyennete"
  };
  const LOCAL_URL = "http://127.0.0.1:8020/frances/Niveau%208/ateliers/prononciation-07d-justice-sociale.html";
