(() => {
  ...
  const STAGES = [
    {
      label: "Section 1",
      shortLabel: "1",
      audio: "../audio/pronunciation/theme-06/section-1.mp3",
      text: "Étant donné que l'IA analyse des données sensibles, nous devons rester prudents."
    },
    {
      label: "Section 2",
      shortLabel: "2",
      audio: "../audio/pronunciation/theme-06/section-2.mp3",
      text: "L'outil peut nous faire gagner du temps, de sorte que les conseillers se concentrent sur les cas complexes."
    },
    {
      label: "Section 3",
      shortLabel: "3",
      audio: "../audio/pronunciation/theme-06/section-3.mp3",
      text: "Il faut une charte claire pour que les utilisateurs comprennent leurs droits."
    },
    {
      label: "Section 4",
      shortLabel: "4",
      audio: "../audio/pronunciation/theme-06/section-4.mp3",
      text: "Sans audit indépendant, déployer cette technologie reviendrait à jouer avec le feu."
    },
    {
      label: "Défi final",
      shortLabel: "Défi",
      final: true,
      audio: "../audio/pronunciation/theme-06/n8-06d-ia-ethique-modele-france.mp3",
      text: "Étant donné que l'IA analyse des données sensibles, nous devons rester prudents. L'outil peut nous faire gagner du temps, de sorte que les conseillers se concentrent sur les cas complexes. Il faut une charte claire pour que les utilisateurs comprennent leurs droits. Sans audit indépendant, déployer cette technologie reviendrait à jouer avec le feu."
    }
  ];

  const API_PATH = "/api/french8/pronunciation-assessment";
  const STORAGE_KEY = "jaralingua:french8:pronunciation-06d:v1";
  const GRADE_SUBMISSION = {
    evaluationId: "pronunciation06d",
    title: "Prononciation 06D - IA et éthique numérique"
  };
  const LOCAL_URL = "http://127.0.0.1:8020/frances/Niveau%208/ateliers/prononciation-06d-ia-ethique.html";
  ...
  function pronunciationTip(word) {
    ...
    const special = {
      "étant": "Enchaînez É-tant sans couper après la première voyelle.",
      "donné": "Gardez le son fermé /e/ dans donné, sans ajouter de syllabe finale.",
      "ia": "Dites les deux lettres clairement : i-a, avec une petite pause possible avant analyse.",
      "analyse": "Gardez trois syllabes régulières : a-na-lyse, avec le s final sonore.",
      "données": "La finale -ées se prononce /e/ ; le s final reste muet.",
      "sensibles": "Ne prononcez pas le s final : sen-si-ble.",
      "prudents": "Le d final de prudent reste muet ; terminez sur le son nasal.",
      "outil": "Faites la liaison naturelle : l'outil, sans séparer l apostrophe de outil.",
      "conseillers": "Dites con-seillers, avec le son /je/ à la fin et sans s final.",
      "comprennent": "Dans comprennent, la terminaison -ent est muette.",
      "droits": "Le groupe oi se prononce /wa/ et le ts final reste muet.",
      "indépendant": "Gardez les deux voyelles nasales : in-dé-pen-dant.",
      "déployer": "Dites dé-ployer avec le son /e/ au début et /je/ à la fin.",
      "reviendrait": "Ouvrez le son final /ɛ/ dans -drait, sans prononcer le t.",
      "jouer": "La finale -er se prononce /e/ : jouer.",
      "feu": "Arrondissez les lèvres pour le son /ø/ de feu."
    };
