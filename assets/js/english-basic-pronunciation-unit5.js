(() => {
  ...
  const STAGES = [
    { label: "Section 1", shortLabel: "1", audio: "audio/pronunciation/unit-5/section-1.mp3", text: "After class, I usually relax at home and watch a funny series." },
    { label: "Section 2", shortLabel: "2", audio: "audio/pronunciation/unit-5/section-2.mp3", text: "I often listen to music or chat with my friends online." },
    { label: "Section 3", shortLabel: "3", audio: "audio/pronunciation/unit-5/section-3.mp3", text: "On Fridays, we sometimes go out for coffee or cook dinner together." },
    { label: "Section 4", shortLabel: "4", audio: "audio/pronunciation/unit-5/section-4.mp3", text: "I rarely play video games, but free time helps me rest and enjoy my week." },
    { label: "Final challenge", shortLabel: "Final", final: true, audio: "audio/pronunciation/unit-5/my-free-time-model-us.mp3", text: "After class, I usually relax at home and watch a funny series. I often listen to music or chat with my friends online. On Fridays, we sometimes go out for coffee or cook dinner together. I rarely play video games, but free time helps me rest and enjoy my week." }
  ];

  const API_PATH = "/api/english-basic/pronunciation-assessment";
  const STORAGE_KEY = "jaralingua:english-basic:pronunciation-unit5:v1";
  const LOCAL_URL = "http://127.0.0.1:8020/ingles/basico/pronunciation-unit-5-my-free-time.html";
