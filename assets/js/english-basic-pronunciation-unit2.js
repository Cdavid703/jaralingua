(() => {
  ...
  const STAGES = [
    { label: "Section 1", shortLabel: "1", audio: "audio/pronunciation/unit-2/section-1.mp3", text: "This is my classroom. The teacher is near the board, and my classmates are at their desks." },
    { label: "Section 2", shortLabel: "2", audio: "audio/pronunciation/unit-2/section-2.mp3", text: "My blue backpack is under the chair, next to a red notebook." },
    { label: "Section 3", shortLabel: "3", audio: "audio/pronunciation/unit-2/section-3.mp3", text: "Those books are on the shelf, but this pencil is mine." },
    { label: "Section 4", shortLabel: "4", audio: "audio/pronunciation/unit-2/section-4.mp3", text: "We are ready for our English lesson today." },
    { label: "Final challenge", shortLabel: "Final", final: true, audio: "audio/pronunciation/unit-2/in-my-classroom-model-us.mp3", text: "This is my classroom. The teacher is near the board, and my classmates are at their desks. My blue backpack is under the chair, next to a red notebook. Those books are on the shelf, but this pencil is mine. We are ready for our English lesson today." }
  ];

  const API_PATH = "/api/english-basic/pronunciation-assessment";
  const STORAGE_KEY = "jaralingua:english-basic:pronunciation-unit2:v1";
  const LOCAL_URL = "http://127.0.0.1:8020/ingles/basico/pronunciation-unit-2-in-my-classroom.html";
  ...
  function pronunciationTip(word) {
    ...
    const special = {
      "this": "Place your tongue lightly between your teeth and use your voice for th /ð/.",
      "those": "Begin with the voiced th /ð/, then keep the long o sound clear.",
      "their": "Use the voiced th /ð/ and finish with a smooth English r.",
      "classroom": "Stress the first part and join both words: CLASS-room.",
      "teacher": "Stress the first syllable: TEA-cher.",
      "classmates": "Stress CLASS and keep the final s sound clear: CLASS-mates.",
      "desks": "Finish with the consonant group /sks/; do not drop the final s.",
      "backpack": "Stress the first part: BACK-pack.",
      "under": "Stress the first syllable and use a smooth r: UN-der.",
      "chair": "Begin with ch /tʃ/ and finish with a smooth r.",
      "notebook": "Stress NOTE and connect both parts: NOTE-book.",
      "shelf": "Keep the short e sound and finish with a clear lf.",
      "pencil": "Stress the first syllable: PEN-cil.",
      "lesson": "Stress the first syllable and keep the final n light: LES-son.",
      "english": "Stress the first syllable: ENG-lish."
    };
