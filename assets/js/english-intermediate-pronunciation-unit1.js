(() => {
  ...
  const STAGES = [
    { label: "Section 1", shortLabel: "1", audio: "audio/pronunciation/unit-1-intermediate/section-1.mp3", text: "People often make quick judgments, but personality is more complex than a first impression." },
    { label: "Section 2", shortLabel: "2", audio: "audio/pronunciation/unit-1-intermediate/section-2.mp3", text: "My friend Daniel seems quiet at first, yet he speaks confidently when he knows the group." },
    { label: "Section 3", shortLabel: "3", audio: "audio/pronunciation/unit-1-intermediate/section-3.mp3", text: "He is thoughtful, reliable, and usually treats others respectfully." },
    { label: "Section 4", shortLabel: "4", audio: "audio/pronunciation/unit-1-intermediate/section-4.mp3", text: "Although he occasionally arrives late, I would describe him as considerate rather than careless." },
    { label: "Final challenge", shortLabel: "Final", final: true, audio: "audio/pronunciation/unit-1-intermediate/beyond-first-impressions-model-us.mp3", text: "People often make quick judgments, but personality is more complex than a first impression. My friend Daniel seems quiet at first, yet he speaks confidently when he knows the group. He is thoughtful, reliable, and usually treats others respectfully. Although he occasionally arrives late, I would describe him as considerate rather than careless." }
  ];

  const API_PATH = "/api/english-intermediate/pronunciation-assessment";
  const STORAGE_KEY = "jaralingua:english-intermediate:pronunciation-unit1:v1";
  const LOCAL_URL = "http://127.0.0.1:8020/ingles/intermediate/pronunciation-unit-1-beyond-first-impressions.html";
  ...
  function normalizeWord(value) {
    ...
    if (lower === "judgements") return "judgments";
  ...
  function pronunciationTip(word) {
    ...
    const special = {
      "judgments": "Keep the final consonant cluster clear: JUDGE-ments.",
      "personality": "Stress NAL: per-so-NAL-i-ty.",
      "complex": "As an adjective, stress the first syllable: COM-plex.",
      "impression": "Stress the second syllable: im-PRES-sion.",
      "daniel": "Say DAN-yel in two smooth syllables.",
      "quiet": "Use two syllables: QUI-et.",
      "confidently": "Stress CON and keep the final -ly light: CON-fi-dent-ly.",
      "thoughtful": "Begin with an unvoiced th /θ/, then say THOUGHT-ful.",
      "reliable": "Stress LI and keep four syllables: re-LI-a-ble.",
      "usually": "Stress U and connect the final syllables: U-su-al-ly.",
      "others": "Begin with a voiced th /ð/: OTH-ers.",
      "respectfully": "Stress SPECT and keep -fully connected: re-SPECT-ful-ly.",
      "although": "Use a voiced th /ð/ and stress THOUGH: al-THOUGH.",
      "occasionally": "Stress CA and keep five syllables: oc-CA-sion-al-ly.",
      "considerate": "Stress SID: con-SID-er-ate.",
      "careless": "Stress CARE and finish with a clear /ləs/: CARE-less."
    };
