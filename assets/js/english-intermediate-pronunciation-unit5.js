(() => {
  ...
  const STAGES = [
    { label: "Section 1", shortLabel: "1", audio: "audio/pronunciation/unit-5-intermediate/section-1.mp3", text: "Use two cups of rice and a can of beans for the main dish." },
    { label: "Section 2", shortLabel: "2", audio: "audio/pronunciation/unit-5-intermediate/section-2.mp3", text: "Add a little oil, a few tomatoes, and some fresh lettuce." },
    { label: "Section 3", shortLabel: "3", audio: "audio/pronunciation/unit-5-intermediate/section-3.mp3", text: "Serve each bowl with pieces of chicken and slices of avocado." },
    { label: "Section 4", shortLabel: "4", audio: "audio/pronunciation/unit-5-intermediate/section-4.mp3", text: "This dinner is healthy, colorful, affordable, and easy to share." },
    { label: "Final challenge", shortLabel: "Final", final: true, audio: "audio/pronunciation/unit-5-intermediate/food-quantities-model-us.mp3", text: "Use two cups of rice and a can of beans for the main dish. Add a little oil, a few tomatoes, and some fresh lettuce. Serve each bowl with pieces of chicken and slices of avocado. This dinner is healthy, colorful, affordable, and easy to share." }
  ];

  const API_PATH = "/api/english-intermediate/pronunciation-assessment";
  const SUBMIT_PATH = "/api/intermediate/unit5-pronunciation/submit";
  const STORAGE_KEY = "jaralingua:english-intermediate:pronunciation-unit5:v1";
  const LOCAL_URL = "http://127.0.0.1:8020/ingles/intermediate/pronunciation-unit-5-food-quantities.html";
  ...
  function pronunciationTip(word) {
    ...
    const special = {
      ...
      "together": "Stress the second syllable: to-GE-ther. Use voiced th /ð/.",
      ...
      "fair": "Use a clear /eər/ sound and do not make it two separate words.",
    ...
    Object.assign(special, {
      "two": "Keep the vowel long and smooth. Connect it to cups: two_cups.",
      "cups": "Finish the final /ps/ clearly without adding an extra vowel.",
      "rice": "Use one clean vowel and finish with a light /s/ sound.",
      "can": "Use a short vowel. In a can of beans, connect can_of smoothly.",
      "beans": "Keep the long vowel and final /nz/ sound.",
      "main": "Hold the long vowel, then connect main dish naturally.",
      "dish": "Finish with the /sh/ sound, not /ch/.",
      "little": "In American English, the middle t is soft: a little sounds like /uh lidl/.",
      "oil": "Use one smooth word. Do not add an extra syllable before oil.",
      "few": "Keep the /f/ clear and the vowel long.",
      "tomatoes": "Stress the second syllable: to-MA-toes.",
      "fresh": "Finish with /sh/ and keep it short.",
      "lettuce": "Stress the first syllable: LET-tuce.",
      "serve": "Use a smooth English r and final /v/.",
      "each": "Start with a clear long vowel and finish with /ch/.",
      "bowl": "Use one syllable with a rounded vowel.",
      "pieces": "Stress the first syllable: PIE-ces.",
      "chicken": "Stress the first syllable: CHICK-en.",
      "slices": "Stress the first syllable and keep the final /iz/ sound.",
      "avocado": "Stress the third syllable: avo-CA-do.",
      "healthy": "Start with a clear /h/ and use the /th/ sound in the middle.",
      "colorful": "Stress the first syllable: COL-or-ful.",
      "affordable": "Stress the second syllable: af-FORD-able.",
      "easy": "Use a long first vowel: EE-zy.",
      "share": "Use a clear /sh/ and a smooth final r."
    });
  ...
  function createSubmitPanel() {
    ...
    function update() {
      ...
      if (!attempt || !Number.isFinite(score)) {
        ...
        panel.querySelector(".unit5-delivery-preview")?.remove();
      ...
      preview.className = "unit5-delivery-preview";
      ...
      try {
        ...
        const response = await fetch(SUBMIT_PATH, {
          ...
          body: JSON.stringify({
            ...
            activityTitle: "Unit 5 Pronunciation - Food Quantities",
