...
evaluation = progress_api.FRENCH8_PRONUNCIATION_EVALUATIONS["pronunciation02d"]
assert evaluation["id"] == "pronunciation02d"
assert evaluation["weight"] == 5
assert evaluation["type"] == "Prononciation"
assert "pronunciation02d" in progress_api.FRENCH8_PRONUNCIATION_AUDIO_REQUIRED
...
details = progress_api.clean_pronunciation_submission_details({
    ...
    "details": {
        ...
        "transcript": "Si j'etais partie plus tot.",
        "referenceText": "Si j'etais partie plus tot.",
        "final": True,
    },
}, "pronunciation02d", 86, 4.3)

assert details["evaluationId"] == "pronunciation02d"
...
print("French 8 pronunciation 02D backend contract checks passed.")
