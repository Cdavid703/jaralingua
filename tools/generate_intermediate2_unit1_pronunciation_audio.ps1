...
$audioRoot = Join-Path $root "ingles\intermediate-2\audio\pronunciation"
$scriptPath = Join-Path $audioRoot "unit-1-people-who-changed-my-circle-script.md"
...
if (-not (Test-Path -LiteralPath $scriptPath)) {
  throw "Missing pronunciation script: $scriptPath"
}
