...
$audioRoot = Join-Path $root "ingles\basico\audio\final-oral-mock"
$scriptPath = Join-Path $audioRoot "final-oral-mock-script.md"
...
if (-not (Test-Path -LiteralPath $scriptPath)) {
  throw "Missing interview script: $scriptPath"
}
