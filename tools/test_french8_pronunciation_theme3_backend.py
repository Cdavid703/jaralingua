...
evaluation = progress_api.FRENCH8_PRONUNCIATION_EVALUATIONS["pronunciation03d"]
assert evaluation["id"] == "pronunciation03d"
assert evaluation["weight"] == 5
assert evaluation["type"] == "Prononciation"
assert "pronunciation03d" in progress_api.FRENCH8_PRONUNCIATION_AUDIO_REQUIRED
...
details = progress_api.clean_pronunciation_submission_details({
    ...
    "details": {
        ...
        "transcript": "Je suis soulagee qu'ils aient reconnu leur erreur.",
        "referenceText": "Je suis soulagee que les responsables aient reconnu leur erreur.",
        "final": True,
    },
}, "pronunciation03d", 86, 4.3)

assert details["evaluationId"] == "pronunciation03d"
...
print("French 8 pronunciation 03D backend contract checks passed.")
