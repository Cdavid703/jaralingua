...
$audioRoot = Join-Path $root "ingles\intermediate\audio\unit-5-food-memory"
$scriptPath = Join-Path $audioRoot "unit-5-food-memory-audio-scripts.md"
...
if (-not (Test-Path -LiteralPath $scriptPath)) {
  throw "Missing audio script: $scriptPath"
}
