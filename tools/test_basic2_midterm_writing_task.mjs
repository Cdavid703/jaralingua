...
assert(page.includes('id="inlineWordCounter"'), 'Inline word counter below the writing area is missing.');
assert(page.includes('id="inlineSubmitHint"'), 'Inline submit hint below the writing area is missing.');
...
assert(js.includes('Ready to submit when you finish reviewing.'), 'Word counter readiness message is missing.');
