"""Audit French Level 1 Unit 3 Conversation Coach audios with ElevenLabs Scribe."""
...
OUTPUT_DIR = ROOT / "frances" / "Niveau 1" / "audio" / "pratique-orale" / "unite-3"

EXPECTED = {
    "question-01.mp3": "Qu’est-ce que tu étudies en ce moment ?",
    "question-02.mp3": "Tu parles français en classe ?",
    "question-03.mp3": "Où est-ce que tu habites ?",
    "question-04.mp3": "Qu’est-ce que le professeur explique aujourd’hui ?",
    "question-05.mp3": "Qu’est-ce que vous répétez en classe ?",
    "question-06.mp3": "Qu’est-ce que nous travaillons aujourd’hui ?",
    "question-07.mp3": "Dis deux actions que tu fais pour apprendre le français.",
    "question-08.mp3": "Décris ta semaine avec trois verbes du premier groupe.",
}
