...
evaluation = progress_api.FRENCH8_PRONUNCIATION_EVALUATIONS["pronunciation01d"]
assert evaluation["id"] == "pronunciation01d"
assert evaluation["weight"] == 5
assert evaluation["type"] == "Prononciation"
assert "pronunciation01d" in progress_api.FRENCH8_PRONUNCIATION_AUDIO_REQUIRED
...
for score100, expected_grade in ((0, 0.0), (20, 1.0), (60, 3.0), (86, 4.3), (100, 5.0)):
    evaluation_id, normalized_score, grade = progress_api.french8_pronunciation_grade_from_payload({
        "evaluationId": "pronunciation01d",
        "score100": score100,
    })
    assert evaluation_id == "pronunciation01d"
    assert normalized_score == score100
    assert grade == expected_grade

details = progress_api.clean_pronunciation_submission_details({
    "activityTitle": "Prononciation 01D - Conditionnel passe",
    "details": {
        "overall": 86,
        "accuracy": 88,
        "completeness": 84,
        ...
        "transcript": "Si j'avais mieux prepare mon voyage.",
        "referenceText": "Si j'avais mieux prepare mon voyage.",
        "final": True,
    },
}, "pronunciation01d", 86, 4.3)

assert details["evaluationId"] == "pronunciation01d"
...
assert details["transcript"] == details["referenceText"]
...
print("French 8 pronunciation 01D backend contract checks passed.")
