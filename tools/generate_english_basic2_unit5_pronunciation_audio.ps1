...
$audioRoot = Join-Path $root "ingles\basico-2\audio\unit5\pronunciation"
$scriptPath = Join-Path $audioRoot "unit-5-pronunciation-audio-scripts.md"
$voices = @{
...
foreach ($item in $items) {
  ...
  New-Item -ItemType Directory -Force -Path (Split-Path -Parent $item.Output) | Out-Null
