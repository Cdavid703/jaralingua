...
$audioRoot = Join-Path $root "ingles\intermediate\audio\conversation-coach\final-oral-partner"
...
if (-not (Test-Path -LiteralPath $scriptPath)) {
  throw "Missing final oral partner coach script: $scriptPath"
}
...
Write-Output "SUMMARY voice=Sophie-US created=$created skipped=$skipped failed=$failed total=$($items.Count)"
