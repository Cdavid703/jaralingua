...
$audioRoot = Join-Path $root "ingles\basico-2\audio\unit2\shopping-memory\cards"
$scriptPath = Join-Path $audioRoot "shopping-memory-card-scripts.md"
...
if (-not (Test-Path -LiteralPath $scriptPath)) {
  throw "Missing shopping memory audio script: $scriptPath"
}
