"""Audit French Level 8 Theme 8 Conversation Coach audios with ElevenLabs Scribe."""
...
OUTPUT_DIR = ROOT / "frances" / "Niveau 8" / "audio" / "pratique-orale" / "theme-08"

EXPECTED = {
    "question-01.mp3": "Vous devez transformer cette phrase en registre standard : T’as deux minutes ? Je sais pas quoi faire.",
    "question-02.mp3": "Vous devez expliquer en français standard : c’est chaud.",
    "question-03.mp3": "Vous devez transformer cette phrase en registre soutenu : je veux vous parler de mon projet.",
    "question-04.mp3": "Expliquez cette variante québécoise : un char.",
    "question-05.mp3": "Remplacez l’expression familière relou par une phrase standard.",
    "question-06.mp3": "Expliquez l’expression sénégalaise : on est ensemble.",
}
...
def normalize(text: str) -> str:
    ...
    text = text.replace("j sais", "j'sais").replace("t as", "t'as")
