...
$audioRoot = Join-Path $root "ingles\basico-2\audio\unit1\weather"
$scriptPath = Join-Path $audioRoot "weather-card-scripts.md"
...
if (-not (Test-Path -LiteralPath $scriptPath)) {
  throw "Missing weather audio script: $scriptPath"
}
