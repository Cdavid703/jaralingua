...
assert(practiceLab.includes("43 activities"), "Practice Lab total count was not updated.");
assert(practiceLab.includes("Unit 6 - 5 activities"), "Practice Lab Unit 6 count was not updated.");
