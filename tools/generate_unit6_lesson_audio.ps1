...
$audioRoot = Join-Path $root "ingles\basico\audio\unit6\lesson"
$scriptPath = Join-Path $audioRoot "unit-6-lesson-audio-scripts.md"
...
if (-not (Test-Path -LiteralPath $scriptPath)) {
  throw "Missing lesson audio script: $scriptPath"
}
