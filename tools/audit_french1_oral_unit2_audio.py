"""Audit French Level 1 Unit 2 Conversation Coach audios with ElevenLabs Scribe."""
...
OUTPUT_DIR = ROOT / "frances" / "Niveau 1" / "audio" / "pratique-orale" / "unite-2"

EXPECTED = {
    "question-01.mp3": "Qu’est-ce que tu fais en classe de français ?",
    "question-02.mp3": "Tu étudies le français tous les jours ?",
    "question-03.mp3": "Qu’est-ce que tu ne fais pas pendant le cours ?",
    "question-04.mp3": "Est-ce que tu comprends les questions en français ?",
    "question-05.mp3": "Où est-ce que tu travailles ou tu étudies ?",
    "question-06.mp3": "Pose une question simple au présent à ton professeur.",
    "question-07.mp3": "Dis une phrase affirmative et une phrase négative sur ton cours de français.",
    "question-08.mp3": "Présente ta routine de français en trois phrases courtes.",
}
