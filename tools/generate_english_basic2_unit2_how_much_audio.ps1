...
$audioRoot = Join-Path $root "ingles\basico-2\audio\unit2\how-much"
$scriptPath = Join-Path $audioRoot "how-much-example-scripts.md"
...
if (-not (Test-Path -LiteralPath $scriptPath)) {
  throw "Missing how much audio script: $scriptPath"
}
