"""Audit French Level 1 Unit 5 Conversation Coach audios with ElevenLabs Scribe."""
...
OUTPUT_DIR = ROOT / "frances" / "Niveau 1" / "audio" / "pratique-orale" / "unite-5"

EXPECTED = {
    "question-01.mp3": "Qui est dans ta famille ?",
    "question-02.mp3": "Tu as des frères ou des sœurs ?",
    "question-03.mp3": "Comment s’appelle ta mère ou ton père ?",
    "question-04.mp3": "Présente une personne de ta famille.",
    "question-05.mp3": "Qui est ton meilleur ami ou ta meilleure amie ?",
    "question-06.mp3": "Dis une phrase avec mon, une phrase avec ma et une phrase avec mes.",
    "question-07.mp3": "Pose une question simple sur la famille de ton camarade.",
    "question-08.mp3": "Présente ta famille en trois phrases courtes.",
}
