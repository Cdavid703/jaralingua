...
9. **Audio:** toda voz, explicación, modelo o botón pedagógico audible usa un archivo real de ElevenLabs. Los efectos mínimos de interfaz —por ejemplo, ticks de una ruleta o alarma de temporizador— pueden usar Web Audio únicamente después de una acción explícita del docente, nunca `speechSynthesis` ni reproducción automática.
