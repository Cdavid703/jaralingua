...
### Modelo de pronunciación integrado — actualización del 11 de septiembre de 2026
Para palabras y expresiones, el texto es el control pulsable, acompañado del pequeño símbolo de sonido. No colocar un botón de reproducción adicional al lado. Usar un botón semántico con aspecto de texto, área mínima de 44 px, foco visible, aria-label descriptivo y aria-pressed sincronizado. Velocidad predeterminada: 0.75×, una sola grabación activa y pausa al cerrar la sección. Cada palabra solicitada tiene un archivo individual; una expresión puede incluir sus ejemplos contextualizados. Mantener guion y metadatos locales, comprobar idioma inglés, acento léxico y transcripción. Corregir una grabación defectuosa con archivo versionado para evitar caché obsoleta. Los audios largos de diálogo pueden conservar controles propios. Toda nueva expresión verbal o idiom debe sincronizarse sin duplicados con Speak Like a Local, la biblioteca compartida enlazada desde Course 2. Las tarjetas conservan definiciones y ejemplos completos al distribuirse en cuatro columnas de escritorio, sin altura fija. Original fue regenerado con contexto de cine en inglés y archivo word-original-v2.mp3.


### Proyección de tarjetas y memoria de Unidad 4 — 18 de septiembre de 2026
Movies and genres, What makes a movie y Music videos and media permiten abrir cada tarjeta en un diálogo que ocupa la pantalla. La imagen muestra la celda completa del recurso visual, sin estirarla ni mostrar las celdas vecinas. El texto se amplía, la pronunciación permanece integrada en el título y se navega con botones o flechas. Escape cierra; el foco vuelve a la tarjeta. La pantalla completa del navegador es opcional. Las palabras pulsables de la tarjeta original siguen reproduciendo audio sin abrir proyección. La explicación distingue see/saw/seen de watch/watched/watched y separa la elección del verbo del cambio de present perfect a past simple.

Movies & Music Memory se publica en Practice Lab → Unit 4: 28 términos (8 elementos de cine, 8 géneros, 12 de música), selecciones temáticas y rondas de 6, 8 o 12 parejas según disponibilidad. Se empareja imagen con definición y palabra; tras un error, el estudiante decide cuándo ocultar las tarjetas. Incluye audio integrado a 0.75×, repaso de aciertos con ejemplos, contador de intentos, teclado y QR. No afecta calificaciones. La fuente de vocabulario reutiliza las definiciones y recursos de la explicación. Pruebas: tools/test_intermediate2_unit4_memory.mjs y tools/test_intermediate2_unit4_projection.mjs.
